...
subtitle: "Reproducible Research - Assignment 1"
author:   "[Leigh Matthews] (https://github.com/leigh-math)"
date:     "April 28, 2016"
output:   
  html_document:
    keep_md: true
...
```{r load_packages, include = FALSE, results = 'hold'}
knitr::opts_chunk$set(echo = TRUE)
knitr::opts_knit$set(base.dir = 'Reproducible Research')
library(knitr)        # Used to 'knit' the document to HTML
library(lubridate)    # Used to formate date to day of the week
library(ggplot2)      # Used for plotting figures
```
...
```{r histogram1, fig.height = 4.5, fig.width = 4.5}
...
```{r TimeSeries, fig.height = 4.5, fig.width = 7}
...
```{r histogram2, fig.height = 4.5, fig.width = 5.5}
...
```{r Panel_Plot , fig.height = 4.5, fig.width = 6}
